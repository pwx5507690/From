...
var CHANGED = false,
    ...
    DEFFLD = {
        ...
        text: {
            ...
            json: '({LBL:"单行文本",TYP:"text",FLDSZ:"150",REQD:"0",UNIQ:"0",SCU:"pub"})',
        ...
        number: {
            ...
            json: '({LBL:"数字框",TYP:"number",FLDSZ:"150",REQD:"0",UNIQ:"0",SCU:"pub"})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        textarea: {
            ...
            json: '({LBL:"多行文本",TYP:"textarea",FLDSZ:"150",REQD:"0",UNIQ:"0",SCU:"pub",MIN:"",MAX:"",DEF:"",INSTR:"",CSS:""})',
        ...
        checkbox: {
            ...
            json: '({LBL:"多选框",TYP:"checkbox",LAY:"one",REQD:"0",SCU:"pub",Source:0,INSTR:"",CSS:"",ITMS:[{VAL:"选项 1",CHKED:"1"},{VAL:"选项 2",CHKED:"2"},{VAL:"选项 3",CHKED:"3"}]})',
        ...
        radio: {
            html: '<label class="desc"><span class="req hide"> *</span></label><div class="content"></div>',
            json: '({LBL:"单选框",TYP:"radio",LAY:"one",REQD:"0",OTHER:"0",Source:0,RDM:"0",SCU:"pub",INSTR:"",CSS:"",ITMS:[{VAL:"选项 1",CHKED:"1"},{VAL:"选项 2",CHKED:"2"},{VAL:"选项 3",CHKED:"3"}]})',
            holder: '<li class="field prefocus" style="height:106px;width:97%"></li>'
        },
        dropdown: {
            html: '<label class="desc"><span class="req hide"> *</span></label><div class="content"><select disabled="disabled" class="m input"></select></div>',
            json: '({LBL:"下拉框",TYP:"dropdown",FLDSZ:"m",REQD:"0",SCU:"pub",Source:0,INSTR:"",CSS:"",ITMS:[{VAL:"选项 1",CHKED:"1"},{VAL:"选项 2",CHKED:"2"},{VAL:"选项 3",CHKED:"3"}]})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        dropdown2: {
            ...
            json: '({LBL:"多级下拉框",TYP:"dropdown2",FLDSZ:"150",pN:"2",REQD:"0",Source:0,SCU:"pub",INSTR:"",CSS:"",SUBFLDS:{DD1:{},DD2:{}},ITMS:[{VAL:"选项 1",CHKED:"1",ITMS:[{VAL:"选项 11"},{VAL:"选项 12"}]},{VAL:"选项 2",CHKED:"0",ITMS:[{VAL:"选项 21"},{VAL:"选项 22"}]}]})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        image: {
        ...
        file: {
            ...
            json: '({LBL:"上传文件",TYP:"file",FLDSZ:"150",REQD:"0",UNIQ:"0",SCU:"pub",INSTR:"",CSS:"",SUBFLDS:{ID:{},TYP:{},SZ:{},NM:{}}})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        phone: {
        ...
        url: {
            ...
            json: '({LBL:"网址",TYP:"url",FLDSZ:"500",REQD:"0",UNIQ:"0",SCU:"pub",DEF:"",INSTR:"",CSS:""})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        money: {
        ...
        email: {
            ...
            json: '({LBL:"Email",TYP:"email",FLDSZ:"150",REQD:"0",UNIQ:"0",SCU:"pub",DEF:"",INSTR:"",CSS:""})',
            holder: '<li class="field prefocus" style="height:71px;width:97%"></li>'
        },
        name: {
...
function createItems(f, b, d) {
    var e,
        a = {
            ...
            dropdown: DEFFLD.item_dropdown,
            dropdown2: DEFFLD.item_dropdown2,
...
function setPropertieValues(c) {
    if (c.TYP == "radio" || c.TYP == "checkbox") {
        $("#fixedtext").show();
        $("#sourceTypeValue").find("option").eq(1).hide();
        $("#api").hide();
    }
    ...
    if (c.TYP == "dropdown") {
        $("#sourceTypeValue").find("option").eq(1).show();
        if (F[IDX].Source == null || +F[IDX].Source != 1) {
            $("#sourceTypeValue").val("fixedtext");
            $("#api").hide();
        } else {
            $("#sourceTypeValue").val("api");
            $("#fixedtext").hide();
            $("#api").show();
            var filed = F[IDX]["SourceFiled"];
            var table = F[IDX]["SourceTable"];
            var param = F[IDX]["apiParam"];
            if (table) {
                $("#table").val(table);
                GetDyncFieldByFormCode(table, function () {
                    $("#filed").val(filed);
                });
            }
            if (param) {
        ...
        sortupdate: function (h, d) {
            ...
            if (!d.item.hasClass('field')) {
                ...
                if (c == 'image') {
                    ...
                    if (j >= imageNumber) {
                        $.alert('最多只能添加' + imageNumber + '张图片，<a href=\'/app/account/manage\' target=\'_blank\' class=\'link\'>升级</a>可添加更多。');
                        setTimeout(function () {
                            d.item.remove()
                        }, 50);
                        return false
                ...
                var f = parseInt(d.item.attr('id').substring(1)),
                    b = F[f];
                F.splice(f, 1);
                F.splice(i, 0, b);
...
function createLikertPreview(i, f) {
    var h = i.ITMS[0].ITMS,
        j = i.ITMS,
        e = f.find('table.table>thead>tr'),
        d = f.find('table.table>tbody'),
        g,
        a;
    e.empty();
    d.empty();
    ...
    for (var i = 0; i < F.length; i++) {
        ...
        if (item["Source"] == 1) {
            ...
            var param = {
                ...
                FiledName: item["SourceFiled"],
                Param: "apiParam"
            }
            item["sourceValue"] = "dyncData/exp/Dropdown?exp=" + item["SourceTable"] + "|"
                + item["SourceFiled"] + "|" + item["apiParam"];
        }
    }

    console.log(JSON.stringify(M));
    console.log(JSON.stringify(F));
    $.postJSON('/CustomFrom/Save',
        { formData: M, parameterData: F, option: initParam.option == 1 ? "Add" : "Update" }, function (g) {
            $.hideStatus();
            if (g.exception) {
                if (g.exception == "401") {
                    location.href = "/auth";
            ...
            location.href = "/CustomFrom/DyncForm";
            return;
            $.extend(true, M, g.M);
            $.extend(true, F, g.F);
            $('#type,#N').prop('disabled', true);
...
function createField(r, q) {
                    ...
                    if (q.TYP === 'address') {
                        ...
                        if (q.TYP === 'radio') {
                            ...
                            if (q.TYP === 'checkbox') {
                                ...
                                if (q.TYP === 'image') {
                                    m.find('img').attr('src', q.IMG ? IMAGESURL + q.IMG : '/Content/CustomFrom/FormDesign/images/defaultimg.png')
                                } else {
                                    if (q.TYP === 'goods') {
    ...
    if (q.TYP === 'dropdown') {
        ...
        if (q.ITMS != null && q.Source == 0) {
            ...
            var value = q.SourceValue ? q.SourceValue.split('=')[1] : "api";
            m.find('select').append($.tmpl('<option>${$data}</option>', value));
            // $("#sourceTypeValue").val("api").change();
        }
    }
    if (q.DEF) {
        var s = [
...
function GetDyncFieldByFormCode(code, callback) {
    $.get("/CustomFrom/GetDyncFieldByFormCode?code=" + code).success(function (data) {
        $("#filed").empty();
        if (data && data.length > 0) {
            $("#filed").append("<option selected value='Id'>标识</option>");
            for (var i = 0; i < data.length; i++) {
                var item = data[i];
                $("#filed").append("<option value='" + item.name + "'>" + item.lbl + "</option>");
            }
        } else {
            $("#filed").html("<option value='-1'>无字段....<option>");
        }
        callback && callback();
    });
};
function initApiSource() {
    var setApiParam = function () {
        F[IDX]["apiParam"] = $(this).val() || "";
        $("#f" + IDX).find("select").empty();
        $("#f" + IDX).find("select").append($.tmpl('<option>${$data}</option>', F[IDX]["SourceTable"] + "|" + F[IDX]["SourceFiled"] + "|" + (F[IDX]["apiParam"] || "")));

    };

    $("#sourceTypeValue").change(function () {
        var value = $(this).val();
        if (value == "api") {
            F[IDX]["Source"] = 1;
            $("#fixedtext").hide();
            ...
            $("#f" + IDX).find("select").empty();
            if (F[IDX].DEF != null) {
                $.each(F[IDX].ITMS, function (j, c) {
                    if (c.CHKED == F[IDX].DEF) {
                        $("#f" + IDX).find("select").append($.tmpl('<option>${$data}</option>', c.VAL));
                        return false
                    }
                });
            } else {
                $("#f" + IDX).find("select").append($.tmpl('<option>${$data}</option>', F[IDX].ITMS[0].VAL));
            }
        }
    ...
    $("#table").change(function () {
        var val = $(this).val();
        F[IDX]["SourceTable"] = val;
        F[IDX]["SourceFiled"] = "Id";
        $("#f" + IDX).find("select").empty();
        $("#f" + IDX).find("select").append($.tmpl('<option>${$data}</option>', F[IDX]["SourceTable"] + "|" + F[IDX]["SourceFiled"] + "|" + (F[IDX]["apiParam"] || "")));

        GetDyncFieldByFormCode(val);
    });
    ...
    $("#filed").change(function () {
        var val = $(this).val();
        F[IDX]["SourceFiled"] = val;
        $("#f" + IDX).find("select").empty();
        $("#f" + IDX).find("select").append($.tmpl('<option>${$data}</option>', F[IDX]["SourceTable"] + "|" + F[IDX]["SourceFiled"] + "|" + (F[IDX]["apiParam"] || "")));
    });
    GetDyncFieldByFormCode($("#table").val());
};
head.ready(function () {
