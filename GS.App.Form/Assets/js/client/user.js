    ...
    function (jQuery, userServices, roleServices, departmentServices, control, app, table, pagination) {
        ...
        var menu = function () {
            ...
            var _elm = {
                ...
                headSculptureImage: "headSculptureImage",
                look:"look"
            };
            ...
            var _getSendData = function () {
                ...
                return {
                    ...
                    role: role,
                    headSculpture: _self.getValue(_elm.headSculpture)
                };
            };
            ...
            var _fillOptionView = function (curentItem) {
                ...
                _self.setValue(_elm.headSculpture, curentItem.headSculpture);

                if (curentItem.headSculpture)
                    _self.get(_elm.look).attr("href", curentItem.headSculpture).show().fancybox();
            ...
            var _createUesrSex = function (sex) {
                ...
                _self.get(_elm.sex).html(temp.join('')).chosen();
            };

            var _initHeadSculpture = function () {
                _self.get(_elm.headSculptureImage).on("click", function () {
                    app.uploaderFile("manager", true, "image/*", function (result) {
                        _self.get(_elm.headSculpture).val(result[0]);
                    });
                });
            };
