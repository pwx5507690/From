...
namespace GS.Common.Util
{
	...
	{		
        ...
        { 
           var imgExtensions = new string[] { ".jpg", ".png", ".jpeg", ".gif", ".bmp" };
		...
		public static void CreateThumbnails(string sourceUrl, string thumbnailsUrl, int width, int height, ThumbnailsType mode = ThumbnailsType.CUT)
		{
			if (File.Exists(thumbnailsUrl))
			{
				File.Delete(thumbnailsUrl);
			}

			Image originalImage = Image.FromFile(sourceUrl);
			int towidth = width;
			int toheight = height;
			...
			switch (mode)
			{
				case ThumbnailsType.HW:
					break;
				case ThumbnailsType.W:
					toheight = originalImage.Height * width / originalImage.Width;
					break;
				case ThumbnailsType.H:
					towidth = originalImage.Width * height / originalImage.Height;
					break;
				case ThumbnailsType.CUT:
			...
			try
			{
				bitmap.Save(thumbnailsUrl, System.Drawing.Imaging.ImageFormat.Jpeg);
			}
			catch (Exception e)
			{
				LogUtil.ErrorFormat("\n Message:}", e.Message);
